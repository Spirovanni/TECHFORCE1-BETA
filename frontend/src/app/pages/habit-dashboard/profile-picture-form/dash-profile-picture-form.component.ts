...
@Component({
  selector: 'dash-app-profile-picture-form',
  templateUrl: './dash-profile-picture-form.component.html',
  styleUrls: ['./dash-profile-picture-form.component.scss']
})

export class DashProfilePictureFormComponent implements OnInit {
