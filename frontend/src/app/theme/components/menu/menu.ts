...
export const verticalMenuItems = [
    ...
    new Menu (5, 'New Habit Form', '/pages/admin', null, 'view_module', null, false, 3),
    new Menu (6, 'UI Features', null, null, 'computer', null, true, 0),
    new Menu (7, 'Admin', '/pages/admin', null, 'folder', null, false, 0),
    new Menu (8, 'Users', '/pages/users', null, 'supervisor_account', null, false, 0),
    new Menu (9, 'Buttons', '/pages/ui/buttons', null, 'keyboard', null, false, 6),
    new Menu (8, 'Cards', '/pages/ui/cards', null, 'card_membership', null, false, 6),
    new Menu (9, 'Lists', '/pages/ui/lists', null, 'list', null, false, 6),
    new Menu (10, 'Grids', '/pages/ui/grids', null, 'grid_on', null, false, 6),
    new Menu (11, 'Tabs', '/pages/ui/tabs', null, 'tab', null, false, 6),
    new Menu (12, 'Expansion Panel', '/pages/ui/expansion-panel', null, 'dns', null, false, 6),
    new Menu (10, 'Chips', '/pages/ui/chips', null, 'label', null, false, 6),
    new Menu (11, 'Progress', '/pages/ui/progress', null, 'data_usage', null, false, 6),
    new Menu (12, 'Dialog', '/pages/ui/dialog', null, 'open_in_new', null, false, 6),
    new Menu (13, 'Tooltip', '/pages/ui/tooltip', null, 'chat_bubble', null, false, 6),
    new Menu (14, 'Snackbar', '/pages/ui/snack-bar', null, 'sms', null, false, 6),
    new Menu (15, 'Dynamic Menu', '/pages/dynamic-menu', null, 'format_list_bulleted', null, false, 0),
    new Menu (16, 'Mailbox', '/pages/mailbox', null, 'email', null, false, 0),
    new Menu (17, 'Chat', '/pages/chat', null, 'chat', null, false, 0),
