...
export const verticalMenuItems = [
    ...
    new Menu (38, 'Autocomplete', '/pages/form-controls/autocomplete', null, 'short_text', null, false, 37),
    new Menu (39, 'Checkbox', '/pages/form-controls/checkbox', null, 'check_box', null, false, 37),
    new Menu (40, 'Datepicker', '/pages/form-controls/datepicker', null, 'today', null, false, 37),
    new Menu (41, 'Form field', '/pages/form-controls/form-field', null, 'view_stream', null, false, 37),
    new Menu (42, 'Input', '/pages/form-controls/input', null, 'input', null, false, 37),
    new Menu (43, 'Radio button', '/pages/form-controls/radio-button', null, 'radio_button_checked', null, false, 37),
    new Menu (44, 'Select', '/pages/form-controls/select', null, 'playlist_add_check', null, false, 37),
    new Menu (45, 'Slider', '/pages/form-controls/slider', null, 'tune', null, false, 37),
    new Menu (46, 'Slide toggle', '/pages/form-controls/slide-toggle', null, 'star_half', null, false, 37),
    new Menu (47, 'Tables', null, null, 'view_module', null, true, 0),
    new Menu (48, 'Basic', '/pages/tables/basic', null, 'view_column', null, false, 47),
    new Menu (49, 'Paging', '/pages/tables/paging', null, 'last_page', null, false, 47),
    new Menu (50, 'Sorting', '/pages/tables/sorting', null, 'sort', null, false, 47),
    new Menu (51, 'Filtering', '/pages/tables/filtering', null, 'format_line_spacing', null, false, 47),
    new Menu (52, 'Selecting', '/pages/tables/selecting', null, 'playlist_add_check', null, false, 47),
    new Menu (53, 'NGX DataTable', '/pages/tables/ngx-table', null, 'view_array', null, false, 47),
    new Menu (54, 'Pages', null, null, 'library_books', null, true, 0),
    new Menu (55, 'Login', '/login', null, 'exit_to_app', null, false, 54),
    new Menu (56, 'Register', '/register', null, 'person_add', null, false, 54),
    new Menu (57, 'Blank', '/blank', null, 'check_box_outline_blank', null, false, 54),
    new Menu (58, 'Page Not Found', '/pagenotfound', null, 'error_outline', null, false, 54),
    new Menu (59, 'Error', '/error', null, 'warning', null, false, 54),
    new Menu (60, 'Search', '/search', null, 'search', null, false, 54),
    new Menu (61, 'Landing', '/landing', null, 'filter', null, false, 54),
