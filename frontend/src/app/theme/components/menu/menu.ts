...
export const verticalMenuItems = [
    ...
    new Menu (7, 'User Dash', '/pages/users-dashboard', null, 'transfer_within_a_station', null, false, 6),
    new Menu (8, 'User List', '/pages/users-list', null, 'assignment_ind', null, false, 6),
    new Menu (9, 'New User', '/pages/admin', null, 'perm_identity', null, false, 6),
    new Menu (10, 'Messages', null, null, 'chrome_reader_mode', null, true, 0),
    new Menu (11, 'Message List', '/pages/messages/message-list', null, 'perm_media', null, false, 9),
    new Menu (12, 'New Message', '/message-form', null, 'note_add', null, false, 9),
    new Menu (13, 'Types', null, null, 'tab', null, true, 0),
    new Menu (14, 'Type List', '/type-list', null, 'description', null, false, 12),
    new Menu (15, 'New Type', '/type-form', null, 'view_module', null, false, 12),
